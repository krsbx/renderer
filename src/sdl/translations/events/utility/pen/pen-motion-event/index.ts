...
export class PenMotionEvent {
  ...
  public constructor(data: Pointer | Uint8Array) {
    if (data instanceof Uint8Array) {
      ...
      const buffer = toArrayBuffer(data, 0, PenMotionEvent.BYTE_SIZE);
  ...
  public static create(data?: StructInit<PenMotionEvent>) {
    const instance = new PenMotionEvent(PenMotionEvent.allocMemory());
