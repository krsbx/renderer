...
export enum GPUTextureUsageFlags {
  ...
  GRAPHICS_STORAGE_READ = 1 <<
    3 /**< Texture supports storage reads in graphics stages. */,
  COMPUTE_STORAGE_READ = 1 <<
    4 /**< Texture supports storage reads in the compute stage. */,
  COMPUTE_STORAGE_WRITE = 1 <<
    5 /**< Texture supports storage writes in the compute stage. */,
  COMPUTE_STORAGE_SIMULTANEOUS_READ_WRITE = 1 <<
...
export enum GPUBufferUsageFlags {
  ...
  GRAPHICS_STORAGE_READ = 1 <<
    3 /**< Buffer supports storage reads in graphics stages. */,
  COMPUTE_STORAGE_READ = 1 <<
    4 /**< Buffer supports storage reads in the compute stage. */,
  COMPUTE_STORAGE_WRITE = 1 <<
    5 /**< Buffer supports storage writes in the compute stage. */,
}
...
export enum GPUSwapchainComposition {
  SDR = 0,
  SDR_LINEAR = 1,
