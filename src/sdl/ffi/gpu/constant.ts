...
export const GPUPrimitiveType = RawGPUPrimitiveType as Readonly<
  Record<keyof typeof RawGPUPrimitiveType, Brand<number, 'GPUPrimitiveType'>>
>;
...
export const GPULoadOp = RawGPULoadOp as Readonly<
  Record<keyof typeof RawGPULoadOp, Brand<number, 'GPULoadOp'>>
>;
...
export const GPUStoreOp = RawGPUStoreOp as Readonly<
  Record<keyof typeof RawGPUStoreOp, Brand<number, 'GPUStoreOp'>>
>;

export type GPUStoreOp = (typeof GPUStoreOp)[keyof typeof GPUStoreOp];

const RawGPUIndexElementSize = {
  '16BIT': 0 /**< The index elements are 16-bit. */,
  '32BIT': 1 /**< The index elements are 32-bit. */,
} as const;

export const GPUIndexElementSize = RawGPUIndexElementSize as Readonly<
  Record<
    keyof typeof RawGPUIndexElementSize,
    Brand<number, 'GPUIndexElementSize'>
  >
>;
...
export const GPUTextureFormat = RawGPUTextureFormat as Readonly<
  Record<keyof typeof RawGPUTextureFormat, Brand<number, 'GPUTextureFormat'>>
>;

export type GPUTextureFormat =
  (typeof GPUTextureFormat)[keyof typeof GPUTextureFormat];

const RawGPUTextureUsageFlags = {
...
export const GPUTextureUsageFlags = RawGPUTextureUsageFlags as Readonly<
  Record<
    keyof typeof RawGPUTextureUsageFlags,
    Brand<number, 'GPUTextureUsageFlags'>
  >
>;
...
export const GPUTextureType = RawGPUTextureType as Readonly<
  Record<keyof typeof RawGPUTextureType, Brand<number, 'GPUTextureType'>>
>;

export type GPUTextureType =
  (typeof GPUTextureType)[keyof typeof GPUTextureType];

const RawGPUSampleCount = {
...
export const GPUSampleCount = RawGPUSampleCount as Readonly<
  Record<keyof typeof RawGPUSampleCount, Brand<number, 'GPUSampleCount'>>
>;

export type GPUSampleCount =
  (typeof GPUSampleCount)[keyof typeof GPUSampleCount];

const RawGPUCubeMapFace = {
  POSITIVEX: 0,
  NEGATIVEX: 1,
  POSITIVEY: 2,
  NEGATIVEY: 3,
...
export const GPUCubeMapFace = RawGPUCubeMapFace as Readonly<
  Record<keyof typeof RawGPUCubeMapFace, Brand<number, 'GPUCubeMapFace'>>
>;

export type GPUCubeMapFace =
  (typeof GPUCubeMapFace)[keyof typeof GPUCubeMapFace];

const RawGPUBufferUsageFlags = {
...
export const GPUBufferUsageFlags = RawGPUBufferUsageFlags as Readonly<
  Record<
    keyof typeof RawGPUBufferUsageFlags,
    Brand<number, 'GPUBufferUsageFlags'>
  >
>;
...
const RawGPUTransferBufferUsage = {
  UPLOAD: 0,
  DOWNLOAD: 1,
} as const;

export const GPUTransferBufferUsage = RawGPUTransferBufferUsage as Readonly<
  Record<
    keyof typeof RawGPUTransferBufferUsage,
    Brand<number, 'GPUTransferBufferUsage'>
  >
>;
...
const RawGPUShaderStage = {
  VERTEX: 0,
  FRAGMENT: 1,
} as const;

export const GPUShaderStage = RawGPUShaderStage as Readonly<
  Record<keyof typeof RawGPUShaderStage, Brand<number, 'GPUShaderStage'>>
>;

export type GPUShaderStage =
  (typeof GPUShaderStage)[keyof typeof GPUShaderStage];

const RawGPUShaderFormat = {
  INVALID: 0,
...
export const GPUShaderFormat = RawGPUShaderFormat as Readonly<
  Record<keyof typeof RawGPUShaderFormat, Brand<number, 'GPUShaderFormat'>>
>;

export type GPUShaderFormat =
  (typeof GPUShaderFormat)[keyof typeof GPUShaderFormat];

const RawGPUVertexElementFormat = {
  INVALID: 0,
...
export const GPUVertexElementFormat = RawGPUVertexElementFormat as Readonly<
  Record<
    keyof typeof RawGPUVertexElementFormat,
    Brand<number, 'GPUVertexElementFormat'>
  >
>;
...
export const GPUVertexInputRate = RawGPUVertexInputRate as Readonly<
  Record<
    keyof typeof RawGPUVertexInputRate,
    Brand<number, 'GPUVertexInputRate'>
  >
>;
...
export const GPUFrontFace = RawGPUFrontFace as Readonly<
  Record<keyof typeof RawGPUFrontFace, Brand<number, 'GPUFrontFace'>>
>;

export type GPUFrontFace = (typeof GPUFrontFace)[keyof typeof GPUFrontFace];

const RawGPUCompareOp = {
  INVALID: 0,
...
export const GPUCompareOp = RawGPUCompareOp as Readonly<
  Record<keyof typeof RawGPUCompareOp, Brand<number, 'GPUCompareOp'>>
>;

export type GPUCompareOp = (typeof GPUCompareOp)[keyof typeof GPUCompareOp];

const RawGPUStencilOp = {
  INVALID: 0,
...
export const GPUStencilOp = RawGPUStencilOp as Readonly<
  Record<keyof typeof RawGPUStencilOp, Brand<number, 'GPUStencilOp'>>
>;
...
export const GPUBlendOp = RawGPUBlendOp as Readonly<
  Record<keyof typeof RawGPUBlendOp, Brand<number, 'GPUBlendOp'>>
>;

export type GPUBlendOp = (typeof GPUBlendOp)[keyof typeof GPUBlendOp];

const RawGPUBlendFactor = {
  INVALID: 0,
  ZERO: 1 /**< 0 */,
  ONE: 2 /**< 1 */,
...
export const GPUBlendFactor = RawGPUBlendFactor as Readonly<
  Record<keyof typeof RawGPUBlendFactor, Brand<number, 'GPUBlendFactor'>>
>;

export type GPUBlendFactor =
  (typeof GPUBlendFactor)[keyof typeof GPUBlendFactor];

const RawGPUColorComponentFlags = {
  R: 1 << 0,
  G: 1 << 1,
  B: 1 << 2,
  A: 1 << 3,
...
export const GPUColorComponentFlags = RawGPUColorComponentFlags as Readonly<
  Record<
    keyof typeof RawGPUColorComponentFlags,
    Brand<number, 'GPUColorComponentFlags'>
  >
>;
...
export const GPUFilter = RawGPUFilter as Readonly<
  Record<keyof typeof RawGPUFilter, Brand<number, 'GPUFilter'>>
>;

export type GPUFilter = (typeof GPUFilter)[keyof typeof GPUFilter];

const RawGPUSamplerMipmapMode = {
  NEAREST: 0 /**< Point filtering. */,
  LINEAR: 1 /**< Linear filtering. */,
} as const;

export const GPUSamplerMipmapMode = RawGPUSamplerMipmapMode as Readonly<
  Record<
    keyof typeof RawGPUSamplerMipmapMode,
    Brand<number, 'GPUSamplerMipmapMode'>
  >
>;
...
const RawGPUSamplerAddressMode = {
...
export const GPUSamplerAddressMode = RawGPUSamplerAddressMode as Readonly<
  Record<
    keyof typeof RawGPUSamplerAddressMode,
    Brand<number, 'GPUSamplerAddressMode'>
  >
>;
...
const RawGPUPresentMode = {
  VSYNC: 0,
  IMMEDIATE: 1,
  MAILBOX: 2,
} as const;

export const GPUPresentMode = RawGPUPresentMode as Readonly<
  Record<keyof typeof RawGPUPresentMode, Brand<number, 'GPUPresentMode'>>
>;

export type GPUPresentMode =
  (typeof GPUPresentMode)[keyof typeof GPUPresentMode];

const RawGPUSwapchainComposition = {
  SDR: 0,
  SDR_LINEAR: 1,
...
export const GPUSwapchainComposition = RawGPUSwapchainComposition as Readonly<
  Record<
    keyof typeof RawGPUSwapchainComposition,
    Brand<number, 'GPUSwapchainComposition'>
  >
>;
