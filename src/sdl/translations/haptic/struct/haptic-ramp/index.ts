...
export class HapticRamp extends BaseStruct {
  ...
  public get start() {
    return this.$view.getInt16(ByteOffset.start, true) as Int16;
  }

  public set start(value: Int16) {
    this.$view.setInt16(ByteOffset.start, value, true);
  }

  public get end() {
    return this.$view.getInt16(ByteOffset.end, true) as Int16;
  }

  public set end(value: Int16) {
