...
export interface RawPenTouchEvent extends RawCommonEvent {
  windowID: number;
  which: number;
  pen_state: PenInputFlags;
  x: number;
...
export interface RawPenButtonEvent extends RawCommonEvent {
  windowID: number;
  which: number;
  pen_state: PenInputFlags;
  x: number;
...
export interface RawPenAxisEvent extends RawCommonEvent {
  windowID: number;
  which: number;
  pen_state: PenInputFlags;
  x: number;
