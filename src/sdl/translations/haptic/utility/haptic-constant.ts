...
export class HapticConstant implements RawHapticConstant {
  ...
  public toMemory() {
    ...
    view.setInt16(30, this.level, true);
    view.setUint16(32, this.attack_length, true);
    view.setUint16(34, this.attack_level, true);
    view.setUint16(36, this.fade_length, true);
    view.setUint16(38, this.fade_level, true);
  ...
  public static fromPointer(pointer: Pointer, sdl: BaseSDL) {
    const result = {
      ...
      level: read.i16(pointer, 30),
      attack_length: read.u16(pointer, 32),
      attack_level: read.u16(pointer, 34),
      fade_length: read.u16(pointer, 36),
      fade_level: read.u16(pointer, 38),
      free: () => {
  ...
  public static fromMemory(data: Uint8Array) {
    ...
    const result = {
      ...
      level: view.getInt16(30, true),
      attack_length: view.getUint16(32, true),
      attack_level: view.getUint16(34, true),
      fade_length: view.getUint16(36, true),
      fade_level: view.getUint16(38, true),
      free: null,
      address: null,
    } as RawHapticConstant;
