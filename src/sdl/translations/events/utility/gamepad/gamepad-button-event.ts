...
import type { RawGamepadButtonEvent } from '../types';
...
export class GamepadButtonEvent implements RawGamepadButtonEvent {
  ...
  public constructor(options: RawGamepadButtonEvent) {
  ...
  public toMemory() {
    const buffer = GamepadButtonEvent.allocMemory();
  ...
  public static fromPointer(pointer: Pointer, sdl: BaseSDL) {
    const result = {
      ...
      address: pointer,
    } as RawGamepadButtonEvent;

    return new GamepadButtonEvent(result);
  }
