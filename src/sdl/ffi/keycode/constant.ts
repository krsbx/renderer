...
export const Keycode = RawKeycode as Readonly<
  Record<keyof typeof RawKeycode, Brand<number, 'Keycode'>>
>;

export type Keycode = (typeof Keycode)[keyof typeof Keycode];

export const RawKeymod = {
  NONE: 0x0000,
  LSHIFT: 0x0001,
  RSHIFT: 0x0002,
  LEVEL5: 0x0004,
...
export const Keymod = RawKeymod as Readonly<
  Record<keyof typeof RawKeymod, Brand<number, 'Keymod'>>
>;
