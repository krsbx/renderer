import type { AudioDeviceID } from '@/sdl/types/definition';
...
export class AudioDeviceEvent extends BaseStruct {
  ...
  public get which() {
    return this.$view.getUint32(ByteOffset.which, true) as AudioDeviceID;
  }

  public set which(value: AudioDeviceID) {
