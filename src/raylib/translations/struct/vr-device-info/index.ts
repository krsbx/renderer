...
export class VrDeviceInfo {
  public static readonly BYTE_SIZE = 60;
  ...
  public constructor(data: Pointer | Uint8Array) {
    if (data instanceof Uint8Array) {
      ...
      const buffer = toArrayBuffer(data, 0, VrDeviceInfo.BYTE_SIZE);
  ...
  public static create(data?: StructInit<VrDeviceInfo>) {
    const instance = new VrDeviceInfo(VrDeviceInfo.allocMemory());
